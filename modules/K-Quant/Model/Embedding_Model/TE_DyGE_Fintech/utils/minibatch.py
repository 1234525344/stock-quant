...
class NodeMinibatchIterator(object):
    ...
    def construct_degs(self):
        ...
        if FLAGS.window > 0:
            min_t = max(self.num_time_steps - FLAGS.window - 1, 0)
        print('nide degrees in rach snapshot',len(degs[min_t:]))
        return degs[min_t:]
    ...
    def next_minibatch_feed_dict(self):
        ...
        # print('batch_nodes',len(batch_nodes))
    ...
    def test_reset(self):
        ...
        self.batch_num = 0
# update 2024-12-08 22:26:45
# update 2025-10-17 00:28:27
