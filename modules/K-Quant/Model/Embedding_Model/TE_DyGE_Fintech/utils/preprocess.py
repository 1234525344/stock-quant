...
def create_data_splits(adj, next_adj, val_mask_fraction=0.2, test_mask_fraction=0.2):
    ...
    for e in edges_next:   # if the index of number is larger than the largest node in current graph
        if e[0] < adj.shape[0] and e[1] < adj.shape[0]:  
            edges.append(e)
    edges = np.array(edges)

    def ismember(a, b, tol=15):
...
# update 2024-10-07 11:21:41
# update 2025-12-05 11:25:45
