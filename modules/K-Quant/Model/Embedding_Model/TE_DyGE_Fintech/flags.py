...
flags.DEFINE_string('dataset', 'FinKG', 'Dataset string.')
flags.DEFINE_integer('time_steps', 1, '# time steps to train (+1)') # Predict at next time step.
