...
class xPath_Dense():
    ...
    This implementation treats a path as a sequence of nodes since there can be multiple paths between a pair of nodes.
    '''
    def __init__(self, model, num_layers=1, device='cpu'):
        self.model = model
    ...
    def dense2sparse(self, rel_matrix, feature, device):
        ...
        unit_matrix_2d = torch.eye(rel_matrix.shape[0])
    ...
    def explain(self, original_preds, g, rel_matrix, stock_id,
