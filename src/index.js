...
async function getIndexQuotes() {
  ...
  try {
    ...
    for (const line of lines) {
      ...
      // 新浪指数格式(sh000001): name(0), preClose(1), open(2), current(3), high(4), low(5), _, _, volume(8), amount(9)
      // 例: 上证指数,4174.38(昨收),4162.18(今开),4077.28(现价),4199.53(最高),4074.22(最低),...,2026-05-21,15:30:39
      const preClose = +fields[1] || 0;
      const open = +fields[2] || 0;
      const current = +fields[3] || 0;
      const high = +fields[4] || 0;
      const low = +fields[5] || 0;
      const volume = +fields[8] || 0;
      const amount = +fields[9] || 0;
      results.push({
...
const ETF_MAP = {
  // 科技
  "半导体": ["512480", "159995"], "芯片": ["159995", "512760"], "集成电路": ["159995"],
  "人工智能": ["159819"], "机器人": ["562500"], "计算机": ["159998", "512720"],
  "通信": ["515050"], "5G": ["515050"], "大数据": ["515400", "159739"],
  "云计算": ["516510", "159890"], "物联网": ["516330", "159701"],
  "软件": ["159852", "515230"], "电子": ["159997", "515260"],
  "传媒": ["512980", "159805"], "游戏": ["159869", "516010"],
  // 金融
  "证券": ["512880", "159841"], "券商": ["512880"], "证券公司": ["512880", "159841"],
  "银行": ["512800", "512700"], "中证银行": ["512800", "512700"],
  "保险": ["512070", "167301"], "金融": ["510230", "159940"],
  // 医药
  "医药": ["512010", "159938"], "医疗": ["512170", "159883"],
  "上证医药": ["512010", "159938"], "中证医疗": ["512170", "159883"],
  "生物医药": ["159859", "512290"], "创新药": ["159858", "516820"],
  "中药": ["159647", "561510"],
  // 新能源
  "新能源": ["516160", "159752"], "新能源车": ["515700", "159806"],
  "新能车": ["515700", "159806"], "CS新能车": ["515700", "159806"],
  "光伏": ["159857", "515790"], "锂电": ["159840", "561160"],
  "碳中和": ["159790", "512580"], "电力": ["159611", "561560"],
  "储能": ["159861", "516850"],
  // 周期 & 资源
  "军工": ["512660", "512670"], "中证军工": ["512660", "512670"],
  "白酒": ["512690"], "消费": ["159928", "512600"],
  "食品饮料": ["515170", "159843"], "家电": ["159996", "561120"],
  "房地产": ["512200", "159768"], "地产": ["512200", "159768"],
  "地产等权": ["512200", "159768"], "基建": ["516950", "159619"],
  "基建工程": ["516950", "159619"],
  "煤炭": ["515220", "159945"], "钢铁": ["515210"],
  "有色": ["159871", "512400"], "稀土": ["516150", "159715"],
  "化工": ["159870", "516120"], "农业": ["159825", "516810"],
  "畜牧": ["159865"], "养殖": ["159865", "516760"],
  "资源": ["510410", "159945"], "A股资源": ["510410", "159945"],
  "公用事业": ["561190"],
  // 宽基
  "央企": ["510060", "512960"], "央企改革": ["512950"],
  "红利": ["510880", "159905"], "中特估": ["512890"],
  "科创50": ["588000", "588080"], "科创100": ["588190", "588220"],
  "创业板": ["159915", "159952"], "沪深300": ["510300", "510310"],
  "中证500": ["510500", "159922"], "上证50": ["510050"],
  "中证1000": ["512100", "560010"], "国证2000": ["159628", "159907"],
  // 跨境
  "恒生科技": ["513130", "513180"], "恒生互联": ["159688", "513330"],
  "港股": ["159954", "513660"], "纳指": ["513100", "159941"],
  "标普500": ["513500", "161125"], "日经": ["513520", "159866"],
  // 商品 & 固收
  "黄金": ["518880", "159934"], "原油": ["159822", "501018"],
  "国债": ["511010", "511260"], "可转债": ["511380", "511180"],
  // 其他
  "一带一路": ["515110"], "ESG": ["516090"],
};

module.exports = { INDEX_LIST, ETF_MAP, getIndexQuotes, getIndexKline, getMarketBreadth, getSectorPerformance, getSectorFlow, getConceptFlow, getStockComments };
